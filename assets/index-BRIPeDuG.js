...
`,Yr=new D(-.45,.22,-.82).normalize(),Op=16762010,zp=15634090,Bp=6056898,pw=1190452,gh=16760952,Al=15709856,kp=42,Hp=260;class mw{mesh;sunDir=Yr;sunColor=new ge(gh);mat;constructor(){this.mat=new _t({vertexShader:dw,fragmentShader:fw,side:Yt,depthWrite:!1,fog:!1,uniforms:{uTime:{value:0},uSunDir:{value:Yr},uHorizon:{value:new ge(Op)},uRose:{value:new ge(zp)},uZenith:{value:new ge(Bp)},uNadir:{value:new ge(pw)},uSunColor:{value:this.sunColor}}}),this.mesh=new ae(new st(480,48,32),this.mat),this.mesh.frustumCulled=!1}update(e){this.mat.uniforms.uTime.value=e}}const gw={uniforms:{tDiffuse:{value:null},uLift:{value:new D(-.008,-.006,-.003)},uGain:{value:new D(1.025,1,.975)},uContrast:{value:1.06},uSat:{value:1.08},uCool:{value:new D(.94,.97,1.05)},uWarm:{value:new D(1.04,1.01,.95)},uVignette:{value:.16},uGrain:{value:.005},uTime:{value:0}},vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
      gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`;function Id(i,e,t,n,s,r){const o=new Pn(n*2.4,n*2.4,i,i);o.rotateX(-Math.PI/2);const a=o.attributes.position;for(let c=0;c<a.count;c++){const l=a.getX(c)+e,h=a.getZ(c)+t,u=r?Ht(l,h):Or(l,h,e,t,n,s);a.setY(c,u),a.setX(c,l),a.setZ(c,h)}return o.computeVertexNormals(),o}function Zw(i){const e=new $s({roughness:.94,metalness:0});return e.onBeforeCompile=t=>{t.uniforms.uSand={value:i.sand},t.uniforms.uGrass={value:i.grass},t.uniforms.uRock={value:i.rock},t.vertexShader=t.vertexShader.replace("#include <common>",`#include <common>
